    ...
    <div class="row">
        ...
        <div class="xs-hidden col-sm-3 col-md-3" id="leftCol">
            <ul class="nav nav-stacked" id="sidebar">
                <li><a href="#sec5"><i class="glyphicon glyphicon-chevron-right"></i> Section 0</a></li>
                <li><a href="#sec0"><i class="glyphicon glyphicon-chevron-right"></i> Section 0</a></li>
                <li><a href="#sec1"><i class="glyphicon glyphicon-chevron-right"></i> Section 1</a></li>
                <li><a href="#sec2"><i class="glyphicon glyphicon-chevron-right"></i> Section 2</a></li>
                <li><a href="#sec3"><i class="glyphicon glyphicon-chevron-right"></i> Section 3</a></li>
                <li><a href="#sec4"><i class="glyphicon glyphicon-chevron-right"></i> Section 4</a></li>
            </ul>
        </div><!--/left-->
